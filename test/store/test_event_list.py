...
class TestEventList(TestCase):
    ...
    def setUp(self):
        ...
        with self.connection.cursor() as cursor:
            ...
            cursor.execute("INSERT INTO event_kinds (`id`, `name`) VALUES (2, '버튼')")
            ...
            cursor.execute("INSERT INTO event_types_kinds (`id`, `event_type_id`, `event_kind_id`) VALUES (2, 1, 2)")
            ...
            cursor.execute("INSERT INTO `event_buttons` (`name`, order_index, event_id) VALUES ('1번 버튼', 1, 2)")
            cursor.execute("INSERT INTO events_products (event_id, product_id) VALUES (1, 1)")
            cursor.execute("INSERT INTO events_products (event_id, product_id, event_button_id) VALUES (2, 2, 1)")
    ...
    def tearDown(self):
        ...
        with self.connection.cursor() as cursor:
            ...
            cursor.execute('truncate event_buttons')
    ...
    def test_get_event_banner_list_is_proceeding(self):
    ...
    def test_get_event_banner_list_is_not_proceeding(self):
        response = self.client.get('/event-list?is_proceeding=0')
        result = [
            {
                'event_banner_image': 'banner_url',
                'event_id': 3,
    ...
    def test_get_event_detail_information(self):
        response = self.client.get('/event-list/1/information')
        result = {
            'detail_image': 'detail_url',
            'event_id': 1,
            'event_kind_id': 1,
            'event_kind_name': '상품',
            'event_type_id': 1,
    ...
    def test_get_event_button_list(self):
        response = self.client.get('/event-list/2/buttons')
        result = [
            {
                'event_id': 2,
                'id': 1,
    ...
    def test_get_event_product_list_is_not_button(self):
        response = self.client.get('/event-list/1')
        result = [
            {
                'discount_rate': 0.1,
    ...
    def test_get_event_product_list_is_button(self):
        response = self.client.get('/event-list/2')
        result = [
            {
                'discount_rate': 0.1,
                'discounted_price': 9000,
